...
/** Used as a result from {@link QuiltLoaderPlugin#scanZip(java.nio.file.Path, boolean, QuiltTreeNode)} and
 * {@link QuiltLoaderPlugin#scanUnknownFile(java.nio.file.Path, boolean, QuiltTreeNode)}. */
