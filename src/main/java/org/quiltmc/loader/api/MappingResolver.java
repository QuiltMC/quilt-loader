...
public interface MappingResolver {
	 ...
	 *
	 * @param fromNamespace the namespace of the provided field name and descriptor
	 ...
	 *
	 * @param fromNamespace the namespace of the provided method name and descriptor
