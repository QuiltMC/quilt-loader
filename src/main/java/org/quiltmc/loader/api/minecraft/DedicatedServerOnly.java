...
/** Applied to declare that the annotated element is present only in the dedicated server environment.
 * <p>
 * When applied to mod code this will result in quilt-loader removing that element when running on the client.
 * <p>
 ...
 * <p>
 * When applied to an implemented interface (via {@link ElementType#TYPE_USE}) it will be removed on the client.
