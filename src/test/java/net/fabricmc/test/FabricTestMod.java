...
public class FabricTestMod implements PreLaunchEntrypoint, ModInitializer {
	/**
	...
	public void onPreLaunch() {
		if (FabricTestMod.class.getClassLoader() != FabricLauncherBase.getLauncher().getTargetClassLoader()) {
			throw new IllegalStateException("invalid class loader: "+ FabricTestMod.class.getClassLoader());
		}

		Log.info(LogCategory.TEST, "In preLaunch (cl %s)", FabricTestMod.class.getClassLoader());
	}
