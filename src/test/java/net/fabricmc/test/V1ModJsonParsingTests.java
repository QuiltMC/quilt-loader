...
final class V1ModJsonParsingTests {
	...
	public void testRequiredValues() throws IOException, ParseMetadataException {
		// Required fields
		final FabricLoaderModMetadata metadata = parseMetadata(specPath.resolve("required.json"));
		...
		final FabricLoaderModMetadata reversedMetadata = parseMetadata(specPath.resolve("required_reversed.json"));
	...
	public void customValues() throws IOException, ParseMetadataException {
		final FabricLoaderModMetadata metadata = parseMetadata(specPath.resolve("custom_values.json"));
	...
	private void validateRequiredValues(FabricLoaderModMetadata metadata) {
